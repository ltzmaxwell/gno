...
// dosChainDepth picks a value-containment chain whose walk is slow enough to be a
// visible halt but short enough that a demonstration run finishes: depth 24 is
